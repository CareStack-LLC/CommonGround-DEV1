...
export default function WalletOnboardingScreen() {
  ...
  const getStepIcon = (step: OnboardingStep, index: number) => {
    ...
    if (step.status === "in_progress") {
      return { name: step.icon, color: colors.accent };
    }
    return { name: step.icon, color: colors.secondary };
  };
    ...
    <SafeAreaView className="flex-1" style={{ backgroundColor: colors.surfaceElevated }} edges={["bottom"]}>
      <ScrollView className="flex-1" contentContainerStyle={{ padding: 16 }}>
        ...
        <View className="items-center mb-8">
          ...
          <Text className="text-2xl font-bold text-center" style={{ color: colors.secondary }}>
            Set Up Payments
          </Text>
        ...
        <View className="mb-6">
          ...
          <View className="h-2 rounded-full" style={{ backgroundColor: colors.backgroundSecondary }}>
            <View
            ...
            return (
              <View key={step.id} className="flex-row mb-4">
                ...
                <View className="items-center mr-4">
                  ...
                  >
                    <Ionicons
                      ...
                      size={20}
                      color={isCompleted ? colors.textInverse : icon.color}
                    />
                  </View>
                ...
                <View
                  ...
                  style={{
                    backgroundColor: isActive ? `${colors.accent}10` : colors.background,
        ...
        {completedSteps < steps.length && (
          ...
          >
            {loading ? (
              ...
              <>
                <Ionicons name="arrow-forward-circle" size={22} color={colors.textInverse} />
