              ...
              <div className="p-6 space-y-6">
                ...
                <div className="grid md:grid-cols-3 gap-6 pt-4 border-t border-slate-50">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="service_location" className="text-slate-700 font-semibold">Service Location</Label>
                      {isEditing ? (
                        <Input
                          id="service_location"
                        ...
                        <div className="p-2 bg-slate-50 rounded-lg border border-slate-100 text-slate-900 font-bold overflow-hidden text-ellipsis whitespace-nowrap">
                          {formData.service_location || "Not specified"}
                        </div>
                      )}
                    </div>
                  </div>
                    ...
                    <>
                              ...
                              <div className="flex flex-wrap gap-2">
                                {FIRM_PRACTICE_AREAS.map((area) => (
                                  <Button
                                    ...
                                    className={firmFormData.practice_areas.includes(area) ? "bg-emerald-600 hover:bg-emerald-700 ring-offset-2" : "text-slate-600 hover:bg-slate-50"}
                                    type="button"
                                  >
                                    {area}
                                  </Button>
                      ...
                      <div className="pt-8 border-t border-slate-200">
                        ...
                        <div className="grid md:grid-cols-2 gap-6 mt-6">
                          <div className="space-y-2">
                            <Label htmlFor="firm_service_location" className="text-slate-600 text-[10px] font-bold uppercase tracking-widest">General Service Location</Label>
                            <Input
                          ...
                          <div className="space-y-2">
                            <ListEditor
                              label="Accepted Payment Methods (e.g. Visa, Zelle)"
                              items={firmFormData.accepted_payment_methods}
                              onAdd={(l) => setFirmFormData(p => ({ ...p, accepted_payment_methods: [...p.accepted_payment_methods, l] }))}
                              onRemove={(i) => setFirmFormData(p => ({ ...p, accepted_payment_methods: p.accepted_payment_methods.filter((_, idx) => idx !== i) }))}
                        ...
                        <div className="mt-8 space-y-4">
                          ...
                          <div className="flex items-center justify-between p-4 bg-slate-50 rounded-xl border border-slate-100">
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                <p className="font-bold text-slate-700">Payment Plans Available</p>
                              </div>
                            </div>
                            <input
                              type="checkbox"
                              checked={firmFormData.payment_plans_available}
                              onChange={e => setFirmFormData(p => ({ ...p, payment_plans_available: e.target.checked }))}
                              className="h-6 w-6 rounded-lg border-slate-300 text-slate-600 focus:ring-slate-500 transition-all cursor-pointer"
                            />
                          </div>
                          ...
                          <div className="flex items-center justify-between p-4 bg-slate-50 rounded-xl border border-slate-100">
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                <p className="font-bold text-slate-700">Works with Nonprofit Programs</p>
                              </div>
                            </div>
                            <input
                              type="checkbox"
                              checked={firmFormData.works_with_nonprofits}
                              onChange={e => setFirmFormData(p => ({ ...p, works_with_nonprofits: e.target.checked }))}
                              className="h-6 w-6 rounded-lg border-slate-300 text-slate-600 focus:ring-slate-500 transition-all cursor-pointer"
                            />
                          </div>
                        </div>
