    ...
    <div className="space-y-8">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        {REPORT_TYPES.map((reportType) => {
          ...
          return (
            <Card
              key={reportType.id}
              className={`border-2 ${reportType.borderColor} hover:shadow-lg transition-all duration-200`}
            >
              <CardHeader>
                <div className="flex items-start gap-4">
                  <div
                    className={`p-3 bg-gradient-to-br ${reportType.color} text-white rounded-xl shadow-md`}
                  >
              ...
              <CardContent className="space-y-4">
                {/* What's Included */}
                <div className={`${reportType.bgColor} border ${reportType.borderColor} rounded-lg p-4`}>
                  <p className={`text-xs font-semibold uppercase tracking-wider mb-2 ${reportType.textColor}`}>
                    What's Included
                  </p>
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          ...
          <Button variant="outline" size="sm" onClick={fetchRecentReports} disabled={isLoading}>
        ...
        {recentReports.length === 0 ? (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
            {recentReports.map((report) => {
              ...
              return (
                <Card key={report.id} className="border-slate-200 hover:shadow-md transition-all">
                  <CardContent className="pt-5">
                    <div className="flex items-start gap-3 mb-3">
                      <div className={`p-2 bg-gradient-to-br ${reportTypeInfo.color} text-white rounded-lg`}>
                    ...
                    {/* SHA-256 Hash */}
                    {report.sha256_hash && (
                      <div className="flex items-center gap-1.5 mb-3 px-2 py-1.5 bg-slate-50 rounded-md border border-slate-200">
        ...
        <Card className="mt-6 bg-blue-50 border-blue-200">
          <CardContent className="py-4 px-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-blue-900">SHA-256 Cryptographic Verification</p>
