          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                ...
                <span className="absolute -top-1 -right-1 h-4 w-4 bg-cg-error rounded-full text-[10px] text-white flex items-center justify-center">
                  2
                </span>
              </Button>
            </div>
...
function NavLink({
  ...
  return (
    ...
    >
      ...
      {children}
      {badge && (
        <span className="ml-1 px-1.5 py-0.5 text-[10px] font-semibold bg-cg-error text-white rounded-full">
          {badge}
        </span>
      )}
    </Link>
...
function MobileNavLink({
  ...
  return (
    ...
    >
      ...
      {badge && (
        <span className="px-1.5 py-0.5 text-[10px] font-semibold bg-cg-error text-white rounded-full">
          {badge}
        </span>
      )}
    </Link>
