...
const plans = [
  ...
  },
  {
    ...
    features: [
      ...
      'Holiday rotation & auto reminders',
  ...
  },
  {
    ...
    whoFor: 'Parents who want verified exchanges, court-ready records, and KidSpace for the kids',
    monthly: 34.99,
    annual: 349.99,
    features: [
      'Everything in Plus',
      'KidSpace for kids — up to 5 approved contacts',
...
const comparisonCategories = [
  ...
  {
    name: 'Children (KidSpace)',
    features: [
      { name: 'KidSpace video & voice calls', free: false, plus: false, complete: true },
      ...
      { name: 'My Circle approved contacts', free: false, plus: false, complete: 'Up to 5' },
      { name: 'Max call duration', free: false, plus: false, complete: '2 hours' },
      { name: 'Full parent control of My Circle', free: false, plus: false, complete: true },
    ],
  },
  {
    name: 'Exchanges',
...
const PRICING_FAQ_ITEMS: { question: string; answer: string }[] = [
  ...
  { question: 'Which plan includes KidSpace for my kids?', answer: 'KidSpace is part of the Complete plan. It gives your children their own safe space to video call, message, and share activities with up to 5 contacts you approve in My Circle — grandparents and close family included. Calls run up to 2 hours, and you control exactly who is in the circle. The free and Plus plans do not include KidSpace.' },
