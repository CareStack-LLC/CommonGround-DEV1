...
export default function KidSpacePage() {
    return (
        <div className="min-h-screen bg-[#F4F8F7] overflow-x-hidden">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
                        ...
                        <div className="flex-1 text-center lg:text-left z-10">
                            ...
                            <p className="text-lg md:text-xl text-slate-600 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                                KidSpace helps families stay connected through stories, movies, and games — built to protect peace during hard transitions. Designed for children ages 3-12.
                            </p>
            ...
            <section className="py-10 bg-white rounded-t-[3rem] shadow-sm relative z-10">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="flex items-center gap-4 bg-emerald-50 rounded-2xl p-5">
                            <div className="w-12 h-12 bg-emerald-100 rounded-xl flex items-center justify-center flex-shrink-0">
                                <Shield className="w-6 h-6 text-emerald-700" />
                            </div>
                            <div>
                                <h3 className="font-bold text-slate-900 text-sm">COPPA Compliant</h3>
                                <p className="text-slate-600 text-xs leading-relaxed">All children's data is protected under federal law.</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-4 bg-amber-50 rounded-2xl p-5">
                            ...
                            <div>
                                <h3 className="font-bold text-slate-900 text-sm">Parent-Controlled</h3>
                                <p className="text-slate-600 text-xs leading-relaxed">Parents approve all contacts and set time limits.</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-4 bg-indigo-50 rounded-2xl p-5">
                            ...
                            <div>
                                <h3 className="font-bold text-slate-900 text-sm">ARIA-Monitored</h3>
                                <p className="text-slate-600 text-xs leading-relaxed">Every message filtered for child safety.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <Card className="bg-white border-none shadow-md hover:shadow-lg transition-shadow duration-300 rounded-3xl overflow-hidden">
                            <CardContent className="p-8">
                                ...
                                <p className="text-slate-600 leading-relaxed">
                                    Bedtime stories that bring comfort across two homes. Kids choose the book, and both parents can co-read — a shared moment that says "we both love you."
                                </p>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-white border-none shadow-md hover:shadow-lg transition-shadow duration-300 rounded-3xl overflow-hidden">
                            <CardContent className="p-8">
                                ...
                                <p className="text-slate-600 leading-relaxed">
                                    Curated, age-appropriate movies and episodes. Start a movie night with one tap — no scheduling fights required.
                                </p>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-white border-none shadow-md hover:shadow-lg transition-shadow duration-300 rounded-3xl overflow-hidden">
                            <CardContent className="p-8">
                                ...
                                <p className="text-slate-600 leading-relaxed">
                                    Cooperative games designed for bonding, not competition. Tic-tac-toe with Grandma, puzzles with Dad — connection through play.
                                </p>
                            </CardContent>
                        </Card>

                        {/* Feature 4: Shared Moments */}
                        <Card className="bg-white border-none shadow-md hover:shadow-lg transition-shadow duration-300 rounded-3xl overflow-hidden">
                            <CardContent className="p-8">
            ...
            <section className="py-12 md:py-16 bg-white relative z-10">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-slate-50 rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center gap-8">
                        <div className="w-16 h-16 bg-cg-sage/10 rounded-2xl flex items-center justify-center flex-shrink-0">
                            <Clock className="w-8 h-8 text-cg-sage" />
                        </div>
                        <div>
                            <h3 className="text-2xl font-bold font-serif text-slate-900 mb-3">
                                Parents set the schedule.
                            </h3>
                            <p className="text-slate-600 leading-relaxed text-lg">
                                Set calling hours, approve contacts, and control screen time — all from your dashboard. You decide who your child connects with and when.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            {/* GRANDPARENT / EXTENDED FAMILY SECTION */}
            <section className="py-16 md:py-20 bg-[#F4F8F7]">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-white rounded-3xl p-8 md:p-12 shadow-md text-center">
                        ...
                        <p className="text-lg text-slate-600 leading-relaxed max-w-2xl mx-auto mb-6">
                            Perfect for grandparents, aunts, uncles — anyone who wants to stay connected with a child they love, even from miles away. Gift a subscription and give them movie nights, story time, and video calls with their grandchild.
                        </p>
                        <Button size="lg" className="rounded-full px-8 py-6 text-lg bg-cg-sage hover:bg-cg-sage-dark shadow-lg shadow-emerald-900/10 transition-all hover:scale-105" asChild>
                            <Link href="/register?plan=plus">Gift KidSpace</Link>
                        </Button>
                    </div>
                </div>
            </section>
                    ...
                    <Accordion type="single" collapsible className="w-full space-y-4">
                        <AccordionItem value="item-1" className="bg-white rounded-2xl px-6 border-none shadow-sm data-[state=open]:pb-4">
                            <AccordionTrigger className="text-lg font-medium text-slate-900 hover:no-underline py-6">
                                What age range is KidSpace designed for?
                            </AccordionTrigger>
                            <AccordionContent className="text-slate-600 leading-relaxed">
                                KidSpace is designed for children ages 3-12. Stories are simpler and more visual for younger children, while games and episodes engage older kids with more interactivity and challenge.
                            </AccordionContent>
                        </AccordionItem>
                        ...
                        <AccordionItem value="item-4" className="bg-white rounded-2xl px-6 border-none shadow-sm data-[state=open]:pb-4">
                            <AccordionTrigger className="text-lg font-medium text-slate-900 hover:no-underline py-6">
                                Can grandparents or extended family use KidSpace?
                            </AccordionTrigger>
                            <AccordionContent className="text-slate-600 leading-relaxed">
                                Absolutely. KidSpace is perfect for grandparents, aunts, uncles, and any approved family member. Parents control who is added as a contact, so extended family can enjoy story time, movie nights, and games with the child in a safe, monitored environment.
                            </AccordionContent>
                        </AccordionItem>

                        <AccordionItem value="item-5" className="bg-white rounded-2xl px-6 border-none shadow-sm data-[state=open]:pb-4">
                            <AccordionTrigger className="text-lg font-medium text-slate-900 hover:no-underline py-6">
                                Is KidSpace COPPA compliant?
                            </AccordionTrigger>
                            <AccordionContent className="text-slate-600 leading-relaxed">
                                Yes. KidSpace is fully COPPA compliant. All children's data is protected under federal law. Parents must approve all contacts, and ARIA monitors every message for child safety.
                            </AccordionContent>
                        </AccordionItem>

                        <AccordionItem value="item-6" className="bg-white rounded-2xl px-6 border-none shadow-sm data-[state=open]:pb-4">
                            <AccordionTrigger className="text-lg font-medium text-slate-900 hover:no-underline py-6">
