      ...
      <section className="pt-12 pb-10 lg:pt-16 lg:pb-14">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <div className="w-16 h-16 rounded-2xl bg-[#3DAA8A]/10 flex items-center justify-center mx-auto mb-6">
            <Shield className="w-8 h-8 text-[#3DAA8A]" />
          </div>
          <h1
      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <section id="what-they-see" className="mb-14 scroll-mt-8">
          <div className="flex items-center gap-3 mb-4">
            <Eye className="w-6 h-6 text-[#3DAA8A] flex-shrink-0" />
            <h2
        ...
        <section id="what-they-cant" className="mb-14 scroll-mt-8">
          <div className="flex items-center gap-3 mb-4">
            <EyeOff className="w-6 h-6 text-[#3DAA8A] flex-shrink-0" />
            <h2
              className="text-2xl text-[#1E3A4A]"
              style={{ fontFamily: "'DM Serif Display', Georgia, serif" }}
            >
          ...
          <ul className="space-y-2.5 text-gray-700">
            <li className="flex items-start gap-2.5">
              <span className="w-1.5 h-1.5 rounded-full bg-[#1E3A4A] mt-2 flex-shrink-0" />
        ...
        <section id="encryption" className="mb-14 scroll-mt-8">
          <div className="flex items-center gap-3 mb-4">
            <Lock className="w-6 h-6 text-[#3DAA8A] flex-shrink-0" />
            <h2
              className="text-2xl text-[#1E3A4A]"
              style={{ fontFamily: "'DM Serif Display', Georgia, serif" }}
            >
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <div className="bg-white rounded-xl border border-gray-100 p-5">
              <h3 className="font-semibold text-[#1E3A4A] mb-2">At rest</h3>
              <p className="text-sm text-gray-600 leading-relaxed">
            ...
            <div className="bg-white rounded-xl border border-gray-100 p-5">
              <h3 className="font-semibold text-[#1E3A4A] mb-2">In transit</h3>
              <p className="text-sm text-gray-600 leading-relaxed">
        ...
        <section id="professional-access" className="mb-14 scroll-mt-8">
          ...
          <ol className="space-y-3 text-gray-700">
            ...
            <li className="flex items-start gap-3">
              <span className="w-6 h-6 rounded-full bg-[#3DAA8A]/10 flex items-center justify-center text-xs font-bold text-[#3DAA8A] flex-shrink-0 mt-0.5">5</span>
        ...
        <section id="data-export" className="mb-14 scroll-mt-8">
          <div className="flex items-center gap-3 mb-4">
            <Download className="w-6 h-6 text-[#3DAA8A] flex-shrink-0" />
            <h2
              className="text-2xl text-[#1E3A4A]"
              style={{ fontFamily: "'DM Serif Display', Georgia, serif" }}
            >
        ...
        <section id="account-deletion" className="mb-14 scroll-mt-8">
          <div className="flex items-center gap-3 mb-4">
            <Trash2 className="w-6 h-6 text-[#3DAA8A] flex-shrink-0" />
            <h2
              className="text-2xl text-[#1E3A4A]"
              style={{ fontFamily: "'DM Serif Display', Georgia, serif" }}
            >
          ...
          <div className="bg-[#F5A623]/5 border-l-4 border-[#F5A623] rounded-lg px-5 py-4">
            <div className="flex items-start gap-3">
              <Lightbulb className="w-5 h-5 text-[#F5A623] mt-0.5 flex-shrink-0" />
              <div>
                <p className="font-semibold text-[#1E3A4A] text-sm mb-1">Good to know</p>
                <p className="text-sm text-gray-600 leading-relaxed">
        ...
        <section id="no-data-selling" className="mb-14 scroll-mt-8">
          <div className="flex items-center gap-3 mb-4">
            <HeartHandshake className="w-6 h-6 text-[#3DAA8A] flex-shrink-0" />
            <h2
              className="text-2xl text-[#1E3A4A]"
              style={{ fontFamily: "'DM Serif Display', Georgia, serif" }}
            >
