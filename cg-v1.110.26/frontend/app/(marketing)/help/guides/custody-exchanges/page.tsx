    ...
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <div className="text-center mb-12">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#3DAA8A]/10 mb-6">
          <MapPin className="w-8 h-8 text-[#3DAA8A]" />
        </div>
        <h1
      ...
      <div className="space-y-16">
        ...
        <section id="exchange-locations">
          <div className="flex items-center gap-3 mb-6">
            <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-[#3DAA8A]/10">
              <MapPinned className="w-5 h-5 text-[#3DAA8A]" />
            </div>
            <h2 className="text-2xl font-bold text-[#1E3A4A]" style={{ fontFamily: 'DM Serif Display, serif' }}>
          ...
          <h3 className="text-lg font-semibold text-[#1E3A4A] mb-3">Recommended location types</h3>
        ...
        <section id="gps-verification">
          <div className="flex items-center gap-3 mb-6">
            <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-[#3DAA8A]/10">
              <Navigation className="w-5 h-5 text-[#3DAA8A]" />
            </div>
            <h2 className="text-2xl font-bold text-[#1E3A4A]" style={{ fontFamily: 'DM Serif Display, serif' }}>
        ...
        <section id="qr-checkin">
          <div className="flex items-center gap-3 mb-6">
            <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-[#3DAA8A]/10">
              <QrCode className="w-5 h-5 text-[#3DAA8A]" />
            </div>
            <h2 className="text-2xl font-bold text-[#1E3A4A]" style={{ fontFamily: 'DM Serif Display, serif' }}>
              QR code check-in
            </h2>
        ...
        <section id="grace-periods">
          <div className="flex items-center gap-3 mb-6">
            <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-[#3DAA8A]/10">
              <Clock className="w-5 h-5 text-[#3DAA8A]" />
            </div>
            <h2 className="text-2xl font-bold text-[#1E3A4A]" style={{ fontFamily: 'DM Serif Display, serif' }}>
