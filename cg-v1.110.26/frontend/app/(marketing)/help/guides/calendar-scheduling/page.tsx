    ...
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <div className="text-center mb-12">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#3DAA8A]/10 mb-6">
          <Calendar className="w-8 h-8 text-[#3DAA8A]" />
        </div>
        <h1
      ...
      <div className="space-y-16">
        ...
        <section id="shared-calendar">
          <div className="flex items-center gap-3 mb-6">
            <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-[#3DAA8A]/10">
              <Calendar className="w-5 h-5 text-[#3DAA8A]" />
            </div>
        ...
        <section id="recurring-schedules">
          <div className="flex items-center gap-3 mb-6">
            <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-[#3DAA8A]/10">
              <Repeat className="w-5 h-5 text-[#3DAA8A]" />
            </div>
            <h2 className="text-2xl font-bold text-[#1E3A4A]" style={{ fontFamily: 'DM Serif Display, serif' }}>
              Setting up recurring schedules
            </h2>
          </div>
          <div className="inline-flex items-center gap-1.5 bg-[#F5A623]/10 text-[#F5A623] text-xs font-semibold px-3 py-1 rounded-full mb-4">
        ...
        <section id="holiday-rotation">
          <div className="flex items-center gap-3 mb-6">
            <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-[#3DAA8A]/10">
              <Snowflake className="w-5 h-5 text-[#3DAA8A]" />
            </div>
            <h2 className="text-2xl font-bold text-[#1E3A4A]" style={{ fontFamily: 'DM Serif Display, serif' }}>
        ...
        <section id="reminders">
          <div className="flex items-center gap-3 mb-6">
            <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-[#3DAA8A]/10">
              <Bell className="w-5 h-5 text-[#3DAA8A]" />
            </div>
            <h2 className="text-2xl font-bold text-[#1E3A4A]" style={{ fontFamily: 'DM Serif Display, serif' }}>
              Automatic reminders
            </h2>
          ...
          <ul className="space-y-2 mb-6">
            <li className="flex items-start gap-2 text-gray-700">
              <Clock className="w-4 h-4 text-[#3DAA8A] mt-1 flex-shrink-0" />
