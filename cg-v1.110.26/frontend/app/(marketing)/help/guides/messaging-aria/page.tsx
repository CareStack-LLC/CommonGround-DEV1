    ...
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <div className="text-center mb-12">
        <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[#3DAA8A]/10 mb-6">
          <Brain className="w-8 h-8 text-[#3DAA8A]" />
        </div>
        <h1
      ...
      <div className="space-y-16">
        ...
        <section id="first-message">
          ...
          <ol className="space-y-3 mb-6">
            ...
            <li className="flex items-start gap-3">
              <span className="flex-shrink-0 w-6 h-6 rounded-full bg-[#3DAA8A] text-white text-sm flex items-center justify-center font-semibold">5</span>
        ...
        <section id="understanding-suggestions">
          <div className="flex items-center gap-3 mb-6">
            <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-[#3DAA8A]/10">
              <MessageCircle className="w-5 h-5 text-[#3DAA8A]" />
            </div>
            <h2 className="text-2xl font-bold text-[#1E3A4A]" style={{ fontFamily: 'DM Serif Display, serif' }}>
          ...
          <h3 className="text-lg font-semibold text-[#1E3A4A] mb-3">Your three options</h3>
          <ul className="space-y-3 mb-6">
            <li className="flex items-start gap-2 text-gray-700">
              <CheckCircle2 className="w-5 h-5 text-[#3DAA8A] mt-0.5 flex-shrink-0" />
              <div>
        ...
        <section id="search-history">
          <div className="flex items-center gap-3 mb-6">
            <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-[#3DAA8A]/10">
              <Search className="w-5 h-5 text-[#3DAA8A]" />
            </div>
            <h2 className="text-2xl font-bold text-[#1E3A4A]" style={{ fontFamily: 'DM Serif Display, serif' }}>
        ...
        <section id="privacy">
          <div className="flex items-center gap-3 mb-6">
            <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-[#3DAA8A]/10">
              <EyeOff className="w-5 h-5 text-[#3DAA8A]" />
            </div>
            <h2 className="text-2xl font-bold text-[#1E3A4A]" style={{ fontFamily: 'DM Serif Display, serif' }}>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white rounded-xl border border-gray-100 p-5">
              <div className="flex items-center gap-2 mb-3">
                <Eye className="w-5 h-5 text-[#3DAA8A]" />
                <h3 className="font-semibold text-[#1E3A4A]">They can see</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-[#3DAA8A] mt-0.5 flex-shrink-0" />The final sent message</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-[#3DAA8A] mt-0.5 flex-shrink-0" />Message timestamps</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-[#3DAA8A] mt-0.5 flex-shrink-0" />Read receipts</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-[#3DAA8A] mt-0.5 flex-shrink-0" />Shared calendar events</li>
              </ul>
            </div>
            <div className="bg-white rounded-xl border border-gray-100 p-5">
              <div className="flex items-center gap-2 mb-3">
                <EyeOff className="w-5 h-5 text-[#F5A623]" />
                <h3 className="font-semibold text-[#1E3A4A]">They cannot see</h3>
              </div>
              <ul className="space-y-2 text-sm text-gray-600">
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-[#F5A623] mt-0.5 flex-shrink-0" />Your drafts or unsent messages</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-[#F5A623] mt-0.5 flex-shrink-0" />ARIA&apos;s suggestions to you</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-[#F5A623] mt-0.5 flex-shrink-0" />Your original wording if you accepted a rewrite</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-[#F5A623] mt-0.5 flex-shrink-0" />Whether ARIA flagged your message</li>
                <li className="flex items-start gap-2"><CheckCircle2 className="w-4 h-4 text-[#F5A623] mt-0.5 flex-shrink-0" />Your ARIA settings or preferences</li>
              </ul>
            </div>
          </div>
        </section>
