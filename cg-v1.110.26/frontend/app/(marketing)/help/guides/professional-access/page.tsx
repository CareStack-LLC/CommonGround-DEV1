      ...
      <section className="pt-12 pb-10 lg:pt-16 lg:pb-14">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <div className="w-16 h-16 rounded-2xl bg-[#3DAA8A]/10 flex items-center justify-center mx-auto mb-6">
            <Scale className="w-8 h-8 text-[#3DAA8A]" />
          </div>
          <h1
      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <section id="who-can-use" className="mb-14 scroll-mt-8">
          <div className="flex items-center gap-3 mb-4">
            <Users className="w-6 h-6 text-[#3DAA8A] flex-shrink-0" />
            <h2
          ...
          <div className="bg-[#F5A623]/5 border-l-4 border-[#F5A623] rounded-lg px-5 py-4 mt-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold text-[#1E3A4A] text-sm mb-1">Free for professionals</p>
        ...
        <section id="how-access-works" className="mb-14 scroll-mt-8">
          <div className="flex items-center gap-3 mb-4">
            <KeyRound className="w-6 h-6 text-[#3DAA8A] flex-shrink-0" />
            <h2
              className="text-2xl text-[#1E3A4A]"
              style={{ fontFamily: "'DM Serif Display', Georgia, serif" }}
            >
        ...
        <section id="getting-started" className="mb-14 scroll-mt-8">
          <div className="flex items-center gap-3 mb-4">
            <Rocket className="w-6 h-6 text-[#3DAA8A] flex-shrink-0" />
            <h2
              className="text-2xl text-[#1E3A4A]"
              style={{ fontFamily: "'DM Serif Display', Georgia, serif" }}
            >
        ...
        <section id="dashboard" className="mb-14 scroll-mt-8">
          <div className="flex items-center gap-3 mb-4">
            <LayoutDashboard className="w-6 h-6 text-[#3DAA8A] flex-shrink-0" />
            <h2
              className="text-2xl text-[#1E3A4A]"
              style={{ fontFamily: "'DM Serif Display', Georgia, serif" }}
            >
        ...
        <section id="case-views" className="mb-14 scroll-mt-8">
          <div className="flex items-center gap-3 mb-4">
            <Layers className="w-6 h-6 text-[#3DAA8A] flex-shrink-0" />
            <h2
              className="text-2xl text-[#1E3A4A]"
              style={{ fontFamily: "'DM Serif Display', Georgia, serif" }}
            >
          ...
          <div className="space-y-4">
            {caseViews.map((view) => (
              <div key={view.name} className="bg-white rounded-xl border border-gray-100 p-5">
                <h3 className="font-semibold text-[#1E3A4A] mb-1">{view.name}</h3>
        ...
        <section id="ai-intake" className="mb-14 scroll-mt-8">
          <div className="flex items-center gap-3 mb-4">
            <Brain className="w-6 h-6 text-[#3DAA8A] flex-shrink-0" />
            <h2
              className="text-2xl text-[#1E3A4A]"
              style={{ fontFamily: "'DM Serif Display', Georgia, serif" }}
            >
        ...
        <section id="reports" className="mb-14 scroll-mt-8">
          <div className="flex items-center gap-3 mb-4">
            <FileBarChart className="w-6 h-6 text-[#3DAA8A] flex-shrink-0" />
            <h2
              className="text-2xl text-[#1E3A4A]"
              style={{ fontFamily: "'DM Serif Display', Georgia, serif" }}
            >
          ...
          <div className="space-y-4">
            {reportTypes.map((report, index) => (
              <div key={report.name} className="bg-white rounded-xl border border-gray-100 p-5">
                <div className="flex items-start gap-3">
                  <span className="w-6 h-6 rounded-full bg-[#3DAA8A]/10 flex items-center justify-center text-xs font-bold text-[#3DAA8A] flex-shrink-0 mt-0.5">
                    {index + 1}
                  </span>
                  <div>
                    <h3 className="font-semibold text-[#1E3A4A] mb-1">{report.name}</h3>
        ...
        <section id="court-evidence" className="mb-14 scroll-mt-8">
          <div className="flex items-center gap-3 mb-4">
            <FileCheck2 className="w-6 h-6 text-[#3DAA8A] flex-shrink-0" />
            <h2
              className="text-2xl text-[#1E3A4A]"
              style={{ fontFamily: "'DM Serif Display', Georgia, serif" }}
            >
          ...
          <div className="bg-[#F5A623]/5 border-l-4 border-[#F5A623] rounded-lg px-5 py-4 mt-6">
            <div className="flex items-start gap-3">
              <Lightbulb className="w-5 h-5 text-[#F5A623] mt-0.5 flex-shrink-0" />
              <div>
                <p className="font-semibold text-[#1E3A4A] text-sm mb-1">Accepted in court</p>
                <p className="text-sm text-gray-600 leading-relaxed">
        ...
        <section id="firm-management" className="mb-14 scroll-mt-8">
          <div className="flex items-center gap-3 mb-4">
            <Building2 className="w-6 h-6 text-[#3DAA8A] flex-shrink-0" />
            <h2
              className="text-2xl text-[#1E3A4A]"
              style={{ fontFamily: "'DM Serif Display', Georgia, serif" }}
            >
          ...
          <h3 className="font-semibold text-[#1E3A4A] mb-3">Setting up a firm</h3>
          ...
          <h3 className="font-semibold text-[#1E3A4A] mb-3">Available roles</h3>
          <ul className="space-y-2.5 text-gray-700">
            <li className="flex items-start gap-2.5">
              <span className="w-1.5 h-1.5 rounded-full bg-[#3DAA8A] mt-2 flex-shrink-0" />
