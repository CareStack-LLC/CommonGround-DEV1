    ...
    <div className="min-h-screen bg-gradient-to-b from-cg-sand via-white to-cg-mist">
      ...
      <section className="py-12 -mt-8">
        <div className="max-w-4xl mx-auto px-6">
          <div className="bg-gradient-to-br from-cg-amber/10 to-cg-amber/5 rounded-3xl p-8 border-2 border-cg-amber/20">
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <h2
            ...
            style={{ fontFamily: 'DM Serif Display, Georgia, serif' }}
          >
            What is <span className="text-cg-amber">CommonGround</span>
          </h2>
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            {serviceDescription.map((item) => (
              <div
                key={item}
                className="flex items-start gap-3 p-4 bg-gradient-to-br from-cg-mist to-white rounded-xl border-2 border-cg-sage/10"
              >
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-4xl mx-auto px-6">
          <h2
            ...
            style={{ fontFamily: 'DM Serif Display, Georgia, serif' }}
          >
            Account <span className="text-cg-amber">Requirements</span>
          </h2>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 border-2 border-cg-sage/10">
              <h3 className="font-semibold text-foreground mb-3">Account Accuracy</h3>
              <p className="text-gray-600 text-sm">
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <h2
            ...
            style={{ fontFamily: 'DM Serif Display, Georgia, serif' }}
          >
            Prohibited <span className="text-cg-amber">Uses</span>
          </h2>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-4xl mx-auto px-6">
          <h2
            ...
            style={{ fontFamily: 'DM Serif Display, Georgia, serif' }}
          >
            ARIA AI <span className="text-cg-amber">Assistant</span>
          </h2>
              ...
              {ariaTerms.map((item) => (
                <li key={item} className="flex items-start gap-3">
                  <div className="w-5 h-5 rounded-full bg-white/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                    <Check className="w-3 h-3 text-cg-amber" />
                  </div>
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <h2
            ...
            style={{ fontFamily: 'DM Serif Display, Georgia, serif' }}
          >
            Court <span className="text-cg-amber">Documentation</span>
          </h2>

          <div className="space-y-6">
            <div className="bg-gradient-to-br from-cg-mist to-white rounded-2xl p-6 border-2 border-cg-sage/10">
              <div className="flex items-start gap-4">
                <div className="w-10 h-10 rounded-xl bg-cg-sage/10 flex items-center justify-center flex-shrink-0">
                  <Shield className="w-5 h-5 text-cg-sage" />
                </div>
                <div>
                  <h3 className="font-semibold text-foreground mb-2">Evidence Integrity</h3>
                  <p className="text-gray-600 text-sm">
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-4xl mx-auto px-6">
          <h2
            ...
            style={{ fontFamily: 'DM Serif Display, Georgia, serif' }}
          >
            Subscription & <span className="text-cg-amber">Payment</span>
          </h2>
          ...
          <div className="space-y-4">
            {[
              ...
              <div
                key={item.title}
                className="bg-white rounded-2xl p-6 border-2 border-cg-sage/10"
              >
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          <h2
            ...
            style={{ fontFamily: 'DM Serif Display, Georgia, serif' }}
          >
            Important <span className="text-cg-amber">Disclaimers</span>
          </h2>
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-4xl mx-auto px-6">
          <h2
            ...
            style={{ fontFamily: 'DM Serif Display, Georgia, serif' }}
          >
            Limitation of <span className="text-cg-amber">Liability</span>
          </h2>

          <div className="bg-white rounded-2xl p-8 border-2 border-cg-sage/10">
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-4xl mx-auto px-6">
          <h2
            ...
            style={{ fontFamily: 'DM Serif Display, Georgia, serif' }}
          >
            Dispute <span className="text-cg-amber">Resolution</span>
          </h2>

          <div className="space-y-6">
            <div className="bg-white rounded-2xl p-6 border-2 border-cg-sage/10">
              <h3 className="font-semibold text-foreground mb-2">Informal Resolution First</h3>
              <p className="text-gray-600 text-sm">
                Before filing a formal dispute, you agree to contact us at{' '}
                <a href="mailto:legal@find-commonground.com" className="text-cg-sage hover:underline">
      ...
      <section className="py-16 sm:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            ...
            <div className="bg-gradient-to-br from-cg-mist to-white rounded-2xl p-6 border-2 border-cg-sage/10">
              <h3 className="font-semibold text-foreground mb-2">Effect</h3>
              <p className="text-gray-600 text-sm">
      ...
      <section className="py-16 sm:py-20">
        <div className="max-w-4xl mx-auto px-6">
          <h2
            ...
            style={{ fontFamily: 'DM Serif Display, Georgia, serif' }}
          >
            General <span className="text-cg-amber">Provisions</span>
          </h2>
