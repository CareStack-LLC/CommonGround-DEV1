...
const settingCards: SettingCard[] = [
  {
    ...
    iconBgGradient: 'from-cg-slate/10 to-cg-slate/5',
  ...
  },
  {
    ...
    iconBgGradient: 'from-cg-sage/10 to-cg-sage-dark/5',
    iconColor: 'text-cg-sage-dark',
  },
  {
    title: 'Notifications',
  ...
  },
  {
    ...
    iconBgGradient: 'from-cg-error/10 to-cg-error/5',
