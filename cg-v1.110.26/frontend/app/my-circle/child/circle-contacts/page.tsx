...
export default function CircleContactsPage() {
  ...
  if (error) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-background via-white to-[#F5F9F9] flex items-center justify-center p-6">
  ...
  if (contacts.length === 0) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-background via-white to-[#F5F9F9] pb-24">
        <header className="bg-white/90 backdrop-blur-sm border-b border-gray-200">
          <div className="max-w-2xl mx-auto px-6 py-6">
            <KidComsLogo size="sm" className="mb-3" />
            <div className="flex items-center gap-2">
              <Users className="w-8 h-8 text-[#2C5F5D]" />
              <h1 className="text-2xl font-bold text-foreground">Circle Contacts</h1>
            </div>
  ...
  return (
    <div className="min-h-screen relative pb-24 bg-gradient-to-b from-background via-white to-[#F5F9F9]">
      {/* Subtle decorative lines */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none opacity-[0.02]">
        <div className="absolute top-32 left-0 w-full h-px bg-[#2C5F5D]" />
        <div className="absolute top-64 right-0 w-3/4 h-px bg-cg-amber" />
      </div>
        ...
        <header className="bg-white/90 backdrop-blur-sm border-b border-gray-200">
          <div className="max-w-2xl mx-auto px-6 py-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold text-foreground">Circle Contacts</h1>
