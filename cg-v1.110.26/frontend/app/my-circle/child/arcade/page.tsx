...
const GAME_GRADIENTS: Record<string, { border: string; glow: string; accent: string }> = {
  tictactoe: {
    border: 'linear-gradient(135deg, var(--cg-slate-light), #349878, var(--cg-slate-light))',
    glow: 'rgba(75, 168, 200, 0.25)',
    accent: 'var(--cg-slate-light)',
  },
  memory: {
    border: 'linear-gradient(135deg, #a855f7, var(--cg-slate), #c084fc)',
    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ background: 'var(--portal-background)' }}>
        <div className="text-center space-y-4">
          <div className="w-16 h-16 rounded-full bg-gradient-to-br from-cg-slate-light to-cg-sage flex items-center justify-center mx-auto animate-pulse">
      ...
      <main className="space-y-6 pt-6 pb-4 px-4">
              ...
              <div className="relative w-full" style={{ paddingBottom: '56.25%' }}>
                ...
                <div className="absolute top-3 left-3">
                  <span
                    ...
                    style={{ background: 'linear-gradient(135deg, var(--cg-slate-light), #349878)' }}
                  >
                    ⭐ Featured
                  </span>
                </div>
        ...
        <section>
          <h2
            ...
            style={{ fontFamily: 'Space Grotesk, sans-serif', color: 'var(--portal-text-heading)' }}
          >
            <Zap className="w-5 h-5" style={{ color: 'var(--cg-sage-light)' }} />
            All Games
          </h2>
