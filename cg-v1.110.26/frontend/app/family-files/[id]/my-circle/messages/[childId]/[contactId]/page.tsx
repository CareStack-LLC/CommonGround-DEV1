        ...
        <PageContainer background="transparent">
          <div className="flex flex-col h-[calc(100vh-180px)]">
            ...
            <div className="flex items-center gap-3 pb-4 border-b border-border mb-4">
              ...
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-teal-500/10 to-cg-slate/10 flex items-center justify-center">
                                ...
                                {!isParent && (
                                  <div className="flex items-center gap-1.5 mb-1 px-1">
                                    <div className={`w-4 h-4 rounded-full flex items-center justify-center ${
                                      isChild ? 'bg-cg-slate-subtle dark:bg-foreground/30' : 'bg-teal-100 dark:bg-teal-900/30'
                                    }`}>
                                      <User className={`h-2.5 w-2.5 ${
                                        isChild ? 'text-cg-slate dark:text-cg-slate-light' : 'text-teal-600 dark:text-teal-400'
                                      }`} />
                                    </div>
                                ...
                                <div
                                  className={`rounded-2xl px-4 py-2.5 ${
                                    isParent
                                      ...
                                      : isChild
                                        ? 'bg-cg-slate-subtle dark:bg-foreground/30 text-foreground rounded-bl-md'
              ...
              <div className="pb-2">
                <div className="relative inline-block">
                  ...
                  <button
                    ...
                    className="absolute -top-2 -right-2 w-5 h-5 bg-cg-error rounded-full flex items-center justify-center hover:bg-cg-error transition-colors"
