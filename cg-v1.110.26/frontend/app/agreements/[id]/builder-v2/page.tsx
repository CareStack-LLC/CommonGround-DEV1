          ...
          <Card className="max-w-md border-2 border-border rounded-2xl shadow-lg">
            ...
            <CardContent>
              ...
              <Button
                ...
                className="bg-gradient-to-r from-[var(--portal-primary)] to-cg-slate hover:opacity-90"
              >
                Back to Agreements
              </Button>
            </CardContent>
      ...
      <div className="bg-card border-b-2 border-border">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          ...
          <div className="w-full bg-muted rounded-full h-2.5 shadow-inner">
            <div
              className="bg-gradient-to-r from-[var(--portal-primary)] to-cg-slate h-2.5 rounded-full transition-all duration-300"
              ...
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-bold transition-all duration-300 whitespace-nowrap border-2 ${
                  index === currentSectionIndex
                    ? 'bg-gradient-to-r from-[var(--portal-primary)] to-cg-slate text-white border-transparent shadow-lg'
                    : completedSections.has(section.key)
                    ? 'bg-cg-sage-subtle text-cg-sage-dark border-cg-sage-subtle hover:shadow-md'
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <Card className="mb-6 border-2 border-cg-amber-subtle rounded-2xl shadow-lg bg-gradient-to-br from-cg-amber-subtle to-white">
            ...
            <CardContent>
              ...
              <div className="mt-6 flex gap-3">
                ...
                <Button
                  onClick={handleContinueAfterSuggestions}
                  className="flex-1 bg-gradient-to-r from-[var(--portal-primary)] to-cg-slate hover:opacity-90 font-bold transition-all duration-300"
                >
                  Continue
                </Button>
              </div>
        ...
        {!showQuickAccordSuggestions && (
          <Card className="border-2 border-border rounded-2xl shadow-lg">
            <CardHeader>
              <div className="flex items-center gap-3">
                <div className="flex items-center justify-center w-12 h-12 rounded-2xl bg-gradient-to-r from-[var(--portal-primary)] to-cg-slate text-white font-bold text-lg shadow-md">
        ...
        {!showQuickAccordSuggestions && (
          <div className="mt-6 flex justify-between">
            ...
            {currentSectionIndex < sections.length - 1 ? (
              <Button
                onClick={handleNext}
                className="bg-gradient-to-r from-[var(--portal-primary)] to-cg-slate hover:opacity-90 font-bold transition-all duration-300 shadow-lg"
              >
                Save & Continue
              ...
              <Button
                onClick={() => router.push(`/agreements/${agreementId}`)}
                className="bg-gradient-to-r from-cg-sage to-cg-sage-dark hover:opacity-90 font-bold transition-all duration-300 shadow-lg"
              >
                Finish Agreement
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border-t-2 border-border pt-6">
        <div className="flex items-start gap-4 p-4 rounded-xl border-2 border-cg-sage-subtle bg-gradient-to-br from-cg-sage-subtle to-white">
          <input
            type="checkbox"
            id="acknowledgment"
