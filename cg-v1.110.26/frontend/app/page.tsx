...
// FAQ accordion needs useState — lazy-loaded since it's below the fold
const FAQSection = dynamic(() => import('@/components/marketing/faq-section'), {
  ssr: true,
});

// Thin client wrapper that redirects authenticated users to /dashboard
...
export default function HomePage() {
  return (
    <>
      {/* Invisible client component — redirects authed users, renders nothing */}
      <AuthRedirectGuard />

      <div className="min-h-screen bg-gradient-to-b from-[#F4F8F7] via-white to-[#E8F4F8]">
        <MarketingHeader />

        {/* Hero Section — LCP content, fully server-rendered */}
          ...
          <div className="max-w-6xl mx-auto px-6 relative">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl sm:text-2xl text-gray-600 mb-8 leading-relaxed max-w-2xl mx-auto">
                End the endless coordination texts. ARIA keeps conversations calm, schedules run on autopilot, and everything is documented
                <br />
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-white/80 mb-6 leading-relaxed">
                  ...
                  Not rewriting your words &mdash; just helping you communicate clearly.
                </p>
                <p className="text-white/60 italic text-sm">
                  &ldquo;ARIA helped me focus on what matters &mdash; my kids.&rdquo;
                  <br />
                  <span className="text-white/40">&mdash; Parent in California</span>
                </p>
              </div>
        ...
        <section className="py-16 sm:py-24 bg-white">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
              <div>
                <div className="text-4xl font-bold text-[var(--portal-primary)] mb-2">Calmer</div>
                <p className="text-sm text-gray-600">Communication, by design</p>
              </div>
              <div>
                <div className="text-4xl font-bold text-[var(--portal-primary)] mb-2">Growing</div>
                <p className="text-sm text-gray-600">Family of parents</p>
              </div>
              <div>
            ...
            <div className="max-w-2xl mx-auto">
              <div className="bg-gradient-to-br from-[#FEF7ED] to-white rounded-3xl p-10 border-2 border-[#F5A623]/10 shadow-lg">
                <p className="text-lg text-gray-700 leading-relaxed mb-6 italic">
                  &ldquo;CommonGround gave us the structure we needed. The kids know what to expect, and everything just runs smoothly now. It changed our family for the better.&rdquo;
                </p>
        ...
        {/* FAQ — client component, lazy loaded */}
        <FAQSection />
