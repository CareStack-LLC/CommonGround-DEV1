...
export default function HomePage() {
  return (
    <>
      ...
      <div className="marketing-light min-h-screen bg-gradient-to-b from-background via-white to-cg-slate-subtle">
        <MarketingHeader />
          ...
          <div className="max-w-6xl mx-auto px-6 relative">
            <div className="grid items-center gap-10 lg:gap-14 lg:grid-cols-2">
              ...
              <div className="text-center lg:text-left">
                <h1 className="font-serif text-foreground text-4xl sm:text-5xl md:text-6xl leading-[1.08] tracking-tight mb-6">
                  The calm way to{' '}
                  <span className="text-cg-sage">co-parent</span>
                </h1>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mb-8">
                  <Link
                    href="/early-access"
                    className="inline-flex items-center justify-center px-8 py-4 bg-[var(--portal-primary)] text-white font-semibold rounded-full hover:bg-cg-sage-dark transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5 group"
                  >
        ...
        ═══════════════════════════════════════════════════════════════ */}
        <section className="bg-gradient-to-r from-background via-white to-cg-sage-subtle border-y border-cg-sage/15">
          <div className="max-w-6xl mx-auto px-6 py-7 sm:py-8">
            <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-5">
              {[
                { Icon: Heart, color: '#E07A5F', label: 'Built by co-parents' },
                { Icon: Lock, color: 'var(--cg-sage)', label: 'Encrypted & private' },
                { Icon: Scale, color: 'var(--cg-slate)', label: 'Attorney-reviewed workflows' },
        ...
        <section className="py-16 sm:py-24 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-12 sm:mb-14">
              <h2
                className="text-3xl sm:text-5xl font-serif text-foreground mb-4"
                style={{ fontFamily: 'var(--font-dm-serif-display), Georgia, serif' }}
              >
                Co-parenting is hard. <span className="text-cg-sage">CommonGround makes it calm.</span>
              </h2>
            ...
            <div className="grid sm:grid-cols-2 gap-5 sm:gap-6 max-w-4xl mx-auto">
              {[
                ...
                >
                  ...
                  <div>
                    <p className="font-serif text-lg text-foreground leading-snug">{problem}</p>
            ...
            <p className="mt-10 text-center text-base sm:text-lg text-gray-700 max-w-2xl mx-auto">
              ...
              <span className="font-semibold text-foreground">court-ready the day you ever need it.</span>
            </p>
          </div>
        </section>
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2
                ...
                style={{ fontFamily: 'var(--font-dm-serif-display), Georgia, serif' }}
              >
                How it <span className="text-cg-sage">works</span>
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
                ...
                return (
                  <div key={item.step} className="text-center">
                    <div className="relative mb-6 mx-auto max-w-[280px]">
                      ...
                      />
                      <div className="absolute -top-3 -left-3 w-10 h-10 rounded-full bg-foreground flex items-center justify-center text-white font-bold text-sm">
                        {item.step}
                      </div>
                    </div>
        ...
        ═══════════════════════════════════════════════════════════════ */}
        <section className="py-16 sm:py-24 bg-gradient-to-br from-foreground to-cg-slate text-white">
          <div className="max-w-6xl mx-auto px-6">
            <HomeARIADemo />
          </div>
        </section>
        ...
        ═══════════════════════════════════════════════════════════════ */}
        <section className="py-16 sm:py-24 bg-gradient-to-br from-background to-white">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2
                className="text-3xl sm:text-5xl font-serif text-foreground mb-4"
                style={{ fontFamily: 'var(--font-dm-serif-display), Georgia, serif' }}
              >
                Fewer fights. Better handoffs. <span className="text-cg-sage">Happier kids.</span>
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-3xl p-8 border-2 border-[var(--portal-primary)]/10 hover:border-[var(--portal-primary)]/30 transition-all hover:shadow-lg group">
                ...
                <h3 className="text-2xl font-semibold text-foreground mb-3">Schedules that run themselves</h3>
              ...
              {/* Benefit 2: Finances */}
              <div className="bg-white rounded-3xl p-8 border-2 border-cg-amber/10 hover:border-cg-amber/30 transition-all hover:shadow-lg group">
                <div className="h-16 w-16 rounded-2xl bg-cg-amber/10 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                  <BrandIcon name="clearfund" size={34} />
                </div>
                <h3 className="text-2xl font-semibold text-foreground mb-3">Money tracked, not argued</h3>
                <p className="text-gray-600 leading-relaxed mb-4">
                ...
                <p className="text-sm font-medium text-cg-amber">ClearFund &mdash; Expense tracking</p>
              </div>
              ...
              <div className="relative bg-white rounded-3xl p-8 border-2 border-[var(--portal-primary)]/10 hover:border-[var(--portal-primary)]/30 transition-all hover:shadow-lg group">
                <div className="absolute top-4 right-4">
                  <span className="inline-flex items-center gap-1 px-3 py-1 bg-cg-amber/10 text-cg-amber text-xs font-bold rounded-full uppercase tracking-wide">
                ...
                <h3 className="text-2xl font-semibold text-foreground mb-3">Call your kids directly</h3>
                <p className="text-gray-600 leading-relaxed mb-4">
              ...
              <div className="relative bg-white rounded-3xl p-8 border-2 border-[var(--portal-primary)]/10 hover:border-[var(--portal-primary)]/30 transition-all hover:shadow-lg group">
                ...
                <h3 className="text-2xl font-semibold text-foreground mb-3">Exchanges without conflict</h3>
                <p className="text-gray-600 leading-relaxed mb-4">
        ...
        <section className="py-16 sm:py-20 bg-white">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-12">
              <h2
                className="text-3xl sm:text-4xl md:text-5xl font-serif text-foreground mb-4"
                style={{ fontFamily: 'var(--font-dm-serif-display), Georgia, serif' }}
              >
                Start free. <span className="text-cg-sage">Upgrade when ready.</span>
              </h2>
              ...
              {PRICING_TEASER_TIERS.map((tier) => (
                <div
                  ...
                  className={`relative flex h-full flex-col rounded-2xl border p-6 lg:p-7 transition-all ${
                    tier.highlight
                      ? 'border-cg-amber shadow-md ring-1 ring-cg-amber/30 bg-gradient-to-br from-cg-amber-subtle to-white'
                      : 'border-gray-100 bg-white shadow-sm hover:border-cg-sage/30 hover:shadow-md'
                  }`}
                >
                  {tier.highlight && (
                    <span className="absolute -top-3 left-1/2 -translate-x-1/2 bg-cg-amber text-white text-xs font-semibold px-3 py-1 rounded-full">
                      Most popular
                    </span>
                  )}
                  ...
                  <div className="mt-4 flex items-baseline gap-1">
                    <span className="font-serif text-3xl sm:text-4xl text-foreground">{tier.price}</span>
                    <span className="text-sm text-gray-500">{tier.period}</span>
                  </div>
                  <ul className="mt-5 space-y-2 flex-1">
                    {tier.features.map((f) => (
                      <li key={f} className="flex items-start gap-2 text-sm text-gray-700">
                        <Check className="h-4 w-4 text-cg-sage mt-0.5 flex-shrink-0" />
                        <span>{f}</span>
                      </li>
                    ))}
                  </ul>
                  <Link
                    ...
                    className={`mt-6 inline-flex items-center justify-center rounded-full px-5 py-2.5 text-sm font-semibold transition-colors ${
                      tier.highlight
                        ? 'bg-foreground text-white hover:bg-[#13252F]'
                        : 'border-2 border-foreground/15 text-foreground hover:border-cg-sage hover:text-cg-sage'
                    }`}
                  >
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-16">
              <h2
                ...
                style={{ fontFamily: 'var(--font-dm-serif-display), Georgia, serif' }}
              >
                Built for every <span className="text-cg-sage">situation</span>
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                return (
                  <div
                    key={useCase.title}
                    className="bg-gradient-to-br from-background to-white rounded-3xl p-8 border-2 border-gray-100 hover:border-[var(--portal-primary)]/20 transition-all hover:shadow-lg"
                  >
                    <div
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <h2
                ...
                style={{ fontFamily: 'var(--font-dm-serif-display), Georgia, serif' }}
              >
                Real families. <span className="text-cg-sage">Real impact.</span>
              </h2>
              <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              ...
              {[
                ...
                return (
                  <div
                    ...
                    className="bg-gradient-to-br from-cg-amber-subtle to-white rounded-3xl p-8 border-2 border-cg-amber/10"
                  >
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-cg-amber">{testimonial.tagline}</p>
                      </div>
                    </div>
                    <Quote className="h-6 w-6 text-cg-amber/30 mb-2" />
        ...
        {/* ═══════════════════════════════════════════════════════════════
            TRUST & SECURITY
        ═══════════════════════════════════════════════════════════════ */}
        <section className="py-16 bg-gradient-to-br from-cg-slate-subtle to-white">
          <div className="max-w-6xl mx-auto px-6">
            <div className="text-center mb-12">
              <h2
            ...
            <div className="grid sm:grid-cols-3 gap-6 max-w-4xl mx-auto">
              ...
              <div className="bg-white rounded-2xl p-6 border-2 border-gray-100 text-center">
                <div className="h-14 w-14 rounded-xl bg-cg-amber/10 flex items-center justify-center mx-auto mb-4">
                  <svg className="h-7 w-7 text-cg-amber" fill="none" viewBox="0 0 24 24" stroke="currentColor">
