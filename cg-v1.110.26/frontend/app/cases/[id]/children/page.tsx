  ...
  return (
    <div className="cg-card">
      <div className="text-center py-16 px-6">
        <div className="w-24 h-24 mx-auto mb-6 rounded-3xl bg-gradient-to-br from-cg-sage-subtle via-cg-amber-subtle to-cg-amber-subtle flex items-center justify-center">
