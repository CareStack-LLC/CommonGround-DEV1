    ...
    <head>
      ...
      <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .section-title::before { content: ''; width: 4px; height: 20px; background: var(--cg-slate); border-radius: 2px; }
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
              ...
              <ul className="space-y-2">
                {data.findings.map((finding: string, idx: number) => (
                  <li key={idx} className="flex items-start gap-2 text-sm text-gray-700">
                    <CheckCircle className="h-4 w-4 text-cg-sage mt-0.5 flex-shrink-0" />
                    {finding}
                  </li>
                ))}
              </ul>
              ...
              <dl className="space-y-3 text-sm">
                {data.orders.legal_custody && (
                  <div className="flex justify-between items-center py-2 border-b border-gray-100">
                    ...
                    <dd className="font-medium text-gray-900 bg-cg-slate-subtle px-3 py-1 rounded">
          ...
          {/* Effective Date */}
          {data.effective_date && (
            <div className="bg-cg-sage-subtle p-4 rounded-lg border border-cg-sage-subtle">
      ...
      <div className="bg-white border-b">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center gap-2 text-sm text-gray-500 mb-2">
            ...
            <span>/</span>
            <Link href={`/cases/${caseId}/court-forms`} className="hover:text-cg-slate">Court Forms</Link>
            <span>/</span>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-6">
        ...
        {saveSuccess && (
          <Alert className="bg-cg-sage-subtle border-cg-sage-subtle">
            ...
            <AlertDescription className="text-cg-sage-dark">
            ...
            <>
              ...
              <Card className="mt-6">
                ...
                <CardContent className="space-y-3">
                  ...
                  <Button aria-label="Send message"
                    className="w-full bg-cg-sage-dark hover:bg-cg-sage-dark"
            ...
            <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
              ...
              {form.aria_assisted && (
                <div>
                  ...
                  <dd className="text-cg-sage-dark">Yes</dd>
                </div>
              )}
            </dl>
          </CardContent>
