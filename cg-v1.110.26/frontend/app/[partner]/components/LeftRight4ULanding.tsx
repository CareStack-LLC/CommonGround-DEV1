        ...
        <div className="min-h-screen bg-[#FDF8F5] text-gray-900 font-sans selection:bg-[#C53030]/30">
            ...
            <div className="grid lg:grid-cols-2 min-h-[90vh]">
                ...
                <div className="relative flex flex-col justify-center p-8 lg:p-16 xl:p-24 order-2 lg:order-1 bg-white">
                    ...
                    <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(ellipse_at_top_left,_var(--tw-gradient-stops))] from-[#C53030]/10 via-transparent to-transparent -z-10" />

                    {/* Logos */}
                    <div className="flex items-center gap-6 mb-12">
                        <div className="flex items-center gap-3">
                            <div className="h-10 w-10 bg-[#C53030] rounded-full flex items-center justify-center font-bold text-white shadow-md">LR</div>
                    ...
                    <p className="text-xl text-gray-600 mb-8 max-w-lg leading-relaxed font-light">
                        Left Right 4 U Foundation partners with CommonGround to provide mothers facing breast cancer or domestic violence with <strong className="text-[#C53030]">grant-funded access</strong> to secure, boundaried co-parenting tools. Focus on healing, not conflict.
                    </p>

                    <div className="flex flex-col sm:flex-row gap-4 mb-8">
                        <Button
                            onClick={scrollToGrant}
                            className="bg-[#C53030] hover:bg-[#C53030] text-white font-bold h-14 px-8 text-lg shadow-lg shadow-[#C53030]/20 transition-all hover:-translate-y-0.5"
                        >
                            Activate Grant Code
                        </Button>
                        <Button
            ...
            <section className="py-24 px-6 bg-white border-y border-gray-100 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-[#5BC4A0]/10 rounded-full blur-[120px] translate-x-1/2 -translate-y-1/2 pointer-events-none" />
                ...
                <div className="max-w-4xl mx-auto text-center mb-16 relative z-10">
                    ...
                    <p className="text-lg text-gray-600 leading-relaxed max-w-3xl mx-auto font-light">
                        That is why we provide <strong className="text-[#5BC4A0]">CommonGround</strong>. It's calm technology that acts as a secure buffer. It blocks hostility, tracks medical appointments transparently, and manages expenses—allowing you to protect your peace and energy for the journey that matters most.
                    </p>
                    <div className="mt-12 p-8 bg-[#FDF8F5] rounded-3xl border border-[#C53030]/10 inline-block shadow-sm">
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-600 max-w-2xl mx-auto text-lg font-light">
                            When your life is in recovery—your co-parenting system must be <strong className="text-[#C53030]">secure, supportive, and completely boundaried.</strong>
                        </p>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            <Card key={idx} className="bg-white border-transparent shadow-sm hover:shadow-xl hover:border-[#C53030]/20 transition-all duration-300 group rounded-3xl">
            ...
            <section id="grant-code-section" className="py-24 px-6 bg-white border-y border-gray-100">
                <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-16 items-center">
                        ...
                        <ul className="space-y-4 mb-8">
                            {[
                                ...
                                <li key={i} className="flex items-start gap-3">
                                    <CheckCircle className="h-5 w-5 text-[#5BC4A0] shrink-0 mt-0.5" />
                                    <span className="text-gray-600 font-light">{item}</span>
                                </li>
                            ))}
                        </ul>

                        <div className="bg-[#FDF8F5] rounded-2xl p-6 border border-[#C53030]/10 shadow-sm">
                            <h4 className="text-[#2D3436] font-bold mb-4 flex items-center gap-2">
                                <ArrowRight className="h-4 w-4 text-[#C53030]" />
                                The Process
                            </h4>
                    ...
                    <div className="bg-white border border-gray-200 rounded-3xl p-8 shadow-xl relative overflow-hidden">
                        <div className="absolute top-0 right-0 w-64 h-64 bg-[#C53030]/5 rounded-full blur-[80px] -translate-y-1/2 translate-x-1/2" />

                        <h3 className="text-2xl font-bold text-gray-900 mb-6 relative z-10">Activate Access</h3>

                        <div className="space-y-5 relative z-10">
                            <label className="block text-sm font-medium text-[#C53030] uppercase tracking-wider">
                            ...
                            <div className="flex gap-3">
                                <Input
                                    ...
                                    className="bg-gray-50 border-gray-300 text-gray-900 placeholder:text-gray-400 h-14 text-lg font-mono focus:border-[#C53030] transition-colors rounded-xl"
                                    disabled={validating || codeValid}
                                />
                                <Button
                                    onClick={handleValidateCode}
                                    disabled={validating || codeValid}
                                    className="bg-[#C53030] hover:bg-[#C53030] text-white font-bold h-14 px-6 rounded-xl shadow-lg shadow-[#C53030]/20 transition-transform hover:-translate-y-0.5"
                                >
                            ...
                            {codeError && (
                                <p className="text-[#C53030] text-sm flex items-center gap-2 animate-in fade-in slide-in-from-top-1 bg-[#C53030]/10 p-3 rounded-lg border border-[#C53030]/20">
                                    <ShieldCheck className="h-4 w-4" />
                                    {codeError}
                                </p>
                            )}
                            {codeValid && (
                                <p className="text-[#5BC4A0] text-sm flex items-center gap-2 animate-in fade-in slide-in-from-top-1 bg-[#5BC4A0]/10 p-3 rounded-lg border border-[#5BC4A0]/20">
                    ...
                    <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex items-center gap-4 mt-8 bg-white p-4 rounded-2xl border border-gray-100 shadow-sm">
                                <div className="h-12 w-12 bg-[#C53030]/10 rounded-full flex items-center justify-center border border-[#C53030]/20">
                                    <HeartPulse className="w-6 h-6 text-[#C53030]" />
                                </div>
            ...
            <section className="py-24 px-6 bg-[#2D3436] text-center relative overflow-hidden">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-3xl h-full bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#C53030]/20 via-transparent to-transparent pointer-events-none" />
                ...
                <div className="max-w-2xl mx-auto relative z-10">
                    ...
                    <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
                        <Button
                            className="bg-[#F5A623] hover:bg-[#F5A623] text-[#2D3436] font-bold h-14 px-8 text-lg rounded-xl shadow-lg shadow-[#F5A623]/20 transition-transform hover:-translate-y-0.5"
