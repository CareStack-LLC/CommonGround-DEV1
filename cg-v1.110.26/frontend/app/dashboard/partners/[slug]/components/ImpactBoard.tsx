    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white font-sans selection:bg-cg-amber/30">
            ...
            <div className="fixed inset-0 z-0 overflow-hidden pointer-events-none">
                <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-cg-amber/10 rounded-full blur-[120px] -translate-x-1/2 -translate-y-1/2" />
                <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-cg-slate/10 rounded-full blur-[120px] translate-x-1/2 translate-y-1/2" />
            </div>
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 py-12">
                ...
                <header className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16 animate-in fade-in slide-in-from-top-4 duration-700">
                    <div>
                        <div className="flex items-center gap-3 mb-4">
                            <span className="px-3 py-1 rounded-full bg-cg-amber/10 border border-cg-amber/20 text-cg-amber text-xs font-medium tracking-wider uppercase">
                                Impact Report
                            </span>
                            <span className="text-gray-500 text-sm flex items-center gap-2">
                                <span className="relative flex h-2 w-2">
                                    <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-cg-sage-light opacity-75"></span>
                                    <span className="relative inline-flex rounded-full h-2 w-2 bg-cg-sage"></span>
                                </span>
                                Updated Live
                            </span>
                        </div>
                        ...
                        {isStaff && (
                            <>
                                ...
                                <Link href={`/dashboard/partners/${partner.partner_slug}/codes`} className="w-full sm:w-auto">
                                    <Button className="w-full bg-white text-gray-900 font-bold hover:bg-cg-amber transition-colors">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 mb-24">
                    ...
                    <Card className="bg-gray-800/40 border-gray-700/50 hover:bg-gray-800/60 transition-colors group">
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between mb-4">
                                <div className="h-10 w-10 rounded-lg bg-cg-amber/10 flex items-center justify-center group-hover:scale-110 transition-transform">
                                    <Users className="h-5 w-5 text-cg-amber" />
                                </div>
                    ...
                    <Card className="bg-gray-800/40 border-gray-700/50 hover:bg-gray-800/60 transition-colors group">
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between mb-4">
                                <div className="h-10 w-10 rounded-lg bg-cg-slate/10 flex items-center justify-center group-hover:scale-110 transition-transform">
                                    <Zap className="h-5 w-5 text-cg-slate-light" />
                                </div>
                    ...
                    <Card className="bg-gray-800/40 border-gray-700/50 hover:bg-gray-800/60 transition-colors group">
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between mb-4">
                                <div className="h-10 w-10 rounded-lg bg-cg-sage/10 flex items-center justify-center group-hover:scale-110 transition-transform">
                                    <Calendar className="h-5 w-5 text-cg-sage-light" />
                                </div>
                    ...
                    <Card className="bg-gray-800/40 border-gray-700/50 hover:bg-gray-800/60 transition-colors group">
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between mb-4">
                                <div className="h-10 w-10 rounded-lg bg-cg-sage/10 flex items-center justify-center group-hover:scale-110 transition-transform">
                                    <MessageSquare className="h-5 w-5 text-cg-sage-light" />
                                </div>
                    ...
                    <Card className="bg-gray-800/40 border-gray-700/50 hover:bg-gray-800/60 transition-colors group">
                        <CardContent className="p-6">
                            <div className="flex items-center justify-between mb-4">
                                <div className="h-10 w-10 rounded-lg bg-cg-slate/10 flex items-center justify-center group-hover:scale-110 transition-transform">
                                    <TrendingUp className="h-5 w-5 text-cg-slate-light" />
                                </div>
                ...
                <div className="grid lg:grid-cols-2 gap-12 mb-24">
                    ...
                    <div className="space-y-8">
                        <div>
                            ...
                            <ul className="space-y-4">
                                <li className="flex gap-3">
                                    <div className="h-6 w-6 rounded-full bg-cg-amber/10 flex items-center justify-center shrink-0 mt-0.5">
                                        <span className="text-cg-amber text-xs font-bold">1</span>
                                    </div>
                                ...
                                <li className="flex gap-3">
                                    <div className="h-6 w-6 rounded-full bg-cg-slate/10 flex items-center justify-center shrink-0 mt-0.5">
                                        <span className="text-cg-slate text-xs font-bold">2</span>
                                    </div>
                                ...
                                <li className="flex gap-3">
                                    <div className="h-6 w-6 rounded-full bg-cg-sage/10 flex items-center justify-center shrink-0 mt-0.5">
                                        <span className="text-cg-sage text-xs font-bold">3</span>
                                    </div>
                                ...
                                <li className="flex gap-3">
                                    <div className="h-6 w-6 rounded-full bg-cg-slate/10 flex items-center justify-center shrink-0 mt-0.5">
                                        <span className="text-cg-slate text-xs font-bold">4</span>
                                    </div>
                            ...
                            <div className="mt-8 p-4 border-l-2 border-cg-amber bg-gray-800/30">
                        ...
                        <div className="bg-gray-800/30 rounded-2xl p-8 border border-gray-700/50">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="flex items-start gap-4">
                                    <div className="p-2 bg-gray-900 rounded-lg border border-gray-700">
                                        <TrendingUp className="h-5 w-5 text-cg-sage" />
                                    </div>
                                    <div>
                    ...
                    <div className="space-y-8">
                        ...
                        {/* Bridge Line */}
                        <div className="flex items-center gap-4 py-4 px-6 bg-gradient-to-r from-cg-amber/10 to-transparent rounded-xl border-l-4 border-cg-amber">
                            <p className="text-lg font-bold text-cg-amber-subtle">
                ...
                <div className="rounded-3xl bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 p-12 text-center relative overflow-hidden">
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto">
                        ...
                        <p className="text-sm font-medium text-cg-amber/80 uppercase tracking-widest">
