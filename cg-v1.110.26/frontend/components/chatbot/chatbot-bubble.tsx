...
export function ChatbotBubble({ isOpen, onClick }: ChatbotBubbleProps) {
  return (
    <button
      ...
      className={cn(
        "fixed bottom-5 right-5 z-[40] flex h-14 w-14 items-center justify-center rounded-full shadow-lg transition-all duration-300 hover:scale-105 active:scale-95",
