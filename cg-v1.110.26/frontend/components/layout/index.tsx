...
export function EmptyState({
  ...
  return (
    <div className={`text-center py-16 px-6 ${className}`}>
      {Icon && (
        <div className="w-20 h-20 mx-auto mb-6 rounded-2xl bg-gradient-to-br from-cg-sage-subtle via-cg-amber-subtle to-cg-amber-subtle flex items-center justify-center">
