        ...
        <div className="h-full flex flex-col bg-slate-50 rounded-xl border border-slate-200 overflow-hidden">
            ...
            <div className="flex items-center gap-2 px-4 py-3 bg-white border-b border-slate-200">
                <div className="p-1.5 bg-cg-slate-subtle rounded-lg">
                    <Bot className="h-4 w-4 text-cg-slate" />
                </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
                ...
                <div className="flex items-start gap-2">
                    <div className="p-1.5 bg-cg-slate-subtle rounded-full shrink-0">
                        <Bot className="h-3.5 w-3.5 text-cg-slate" />
                    </div>
                ...
                {section?.questions.map((q, qi) => (
                    <div key={q.id} className="space-y-2">
                        ...
                        <div className="flex justify-end">
                            <div className="bg-cg-slate text-white rounded-xl rounded-tr-sm px-3 py-2 max-w-[70%]">
                                {q.type === "yes_no" ? (
            ...
            <div className="border-t border-slate-200 p-3 bg-white">
                <div className="flex gap-2 bg-slate-50 rounded-lg px-3 py-2 border border-slate-200">
                    ...
                    />
                    <div className="p-1 bg-cg-slate rounded-md opacity-50">
...
function QuestionEditor({
    ...
    return (
        <div
            ...
            className={`group flex items-start gap-2 p-3 bg-white rounded-lg border transition-all ${isDragging ? "opacity-40 border-cg-slate-light shadow-inner" : "border-slate-100 hover:border-slate-200 hover:shadow-sm"
                }`}
        >
            {/* Drag handle */}
            ...
            <div className="flex-1 space-y-2">
                ...
                <div className="flex items-center gap-2">
                    <input
                        ...
                        className="w-3.5 h-3.5 accent-cg-slate"
                    />
            ...
            <button aria-label="Delete"
                onClick={onDelete}
                className="mt-1 text-slate-300 hover:text-cg-error transition-colors opacity-0 group-hover:opacity-100"
            >
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center gap-2 p-3 border-b border-slate-100">
                ...
                {total > 1 && (
                    <button aria-label="Delete" onClick={onDelete} className="text-slate-300 hover:text-cg-error transition-colors">
                        <Trash2 className="h-4 w-4" />
                    </button>
                )}
            </div>
            ...
            <div className="flex items-center justify-between gap-4 pb-4 border-b border-slate-200 mb-4">
                <div className="flex items-center gap-3 flex-1 min-w-0">
                    <Input
                        ...
                        className="max-w-xs h-9 font-semibold text-slate-800 border-slate-200 focus:border-cg-slate-light"
                    />
