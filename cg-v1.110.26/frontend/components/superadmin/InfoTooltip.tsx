...
export function InfoTooltip({ text }: InfoTooltipProps) {
  ...
  return (
    ...
    >
      ...
      {show && (
        <span className="absolute z-50 bottom-full left-1/2 -translate-x-1/2 mb-2 px-3 py-2 text-xs text-[#D0E4EC] bg-foreground border border-cg-slate/40 rounded-lg shadow-xl whitespace-normal w-56 text-center leading-relaxed">
          {text}
