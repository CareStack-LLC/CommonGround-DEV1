    ...
    return (
      <div className={cn('bg-card rounded-2xl border border-border p-6', className)}>
        ...
        <div className="text-center py-8">
          <div className="w-16 h-16 rounded-full bg-cg-slate-subtle dark:bg-foreground/30 flex items-center justify-center mx-auto mb-3">
            <Phone className="h-8 w-8 text-cg-slate-light" />
          </div>
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div className={cn(
                ...
                call.call_type === 'video' ? 'bg-cg-slate-subtle dark:bg-foreground/30' : 'bg-muted'
              )}>
