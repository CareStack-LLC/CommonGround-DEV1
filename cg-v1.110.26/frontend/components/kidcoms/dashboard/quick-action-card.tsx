...
const colorStyles = {
  teal: {
    bg: 'bg-gradient-to-br from-cg-sage to-cg-slate-light',
    shadow: 'shadow-cg-sage/20',
  },
  red: {
  ...
  cyan: {
    bg: 'bg-gradient-to-br from-cg-slate-light to-cg-sage',
    shadow: 'shadow-cg-slate-light/20',
  },
};
