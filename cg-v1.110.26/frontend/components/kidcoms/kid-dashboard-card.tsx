...
const colorStyles = {
  ...
  red: {
    ...
    bg: 'bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-950/50 dark:to-orange-950/50',
    accent: 'bg-red-500'
  }
};
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "relative bg-card rounded-xl p-6",
    ...
    >
      ...
      <h3 className="text-base md:text-lg font-bold text-foreground text-center leading-tight mb-1 tracking-tight" style={{ fontFamily: 'Space Grotesk, DM Sans, sans-serif' }}>
        {title}
      </h3>

      {/* Subtitle - using Inter font */}
      {subtitle && (
        <p className="text-sm text-muted-foreground font-medium text-center" style={{ fontFamily: 'Inter, DM Sans, sans-serif' }}>
          {subtitle}
        </p>
      )}
