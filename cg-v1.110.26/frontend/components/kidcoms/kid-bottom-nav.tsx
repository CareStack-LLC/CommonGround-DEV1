  ...
  return (
    <Link
      ...
      className={cn(
        ...
        'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cg-sage focus-visible:ring-offset-1',
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(90deg, var(--cg-sage), var(--cg-slate), var(--cg-slate-light))',
        }}
      />
    </Link>
  );
