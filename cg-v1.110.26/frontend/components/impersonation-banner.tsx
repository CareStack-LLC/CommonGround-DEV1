...
export function ImpersonationBanner() {
  ...
  return (
    <div className="fixed top-0 inset-x-0 z-[100] bg-amber-500/95 backdrop-blur-sm text-amber-950 shadow-lg">
      <div className="max-w-7xl mx-auto px-4 py-2 flex items-center justify-between gap-4 flex-wrap">
        ...
        <button
          onClick={handleEnd}
          disabled={ending}
          className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded bg-amber-900/20 hover:bg-amber-900/30 text-amber-950 text-xs font-semibold border border-amber-900/30 transition-colors disabled:opacity-50"
        >
