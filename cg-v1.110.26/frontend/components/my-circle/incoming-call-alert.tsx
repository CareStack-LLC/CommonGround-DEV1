      ...
      <div className="bg-card rounded-3xl p-8 max-w-sm w-full shadow-2xl animate-in zoom-in-95">
        ...
        <div className="text-center mb-8">
          ...
          <div className="relative mx-auto w-24 h-24 mb-6">
            <div className="absolute inset-0 rounded-full bg-cg-sage-subtle animate-ping opacity-75" />
            <div className="absolute inset-0 rounded-full bg-cg-sage-subtle animate-pulse" />
            <div className="relative w-24 h-24 rounded-full bg-gradient-to-br from-cg-sage-light to-cg-sage flex items-center justify-center shadow-lg">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <button
            ...
            className="flex flex-col items-center gap-2 p-4 bg-cg-error-subtle hover:bg-cg-error-subtle rounded-2xl transition-all hover:scale-105 disabled:opacity-50 disabled:hover:scale-100"
          >
            {isRejecting ? (
              <Loader2 className="h-8 w-8 text-cg-error animate-spin" />
            ) : (
              <div className="w-14 h-14 rounded-full bg-cg-error flex items-center justify-center shadow-md">
          ...
          <button
            ...
            disabled={isAccepting || isRejecting}
            className="flex flex-col items-center gap-2 p-4 bg-cg-sage-subtle hover:bg-cg-sage-subtle rounded-2xl transition-all hover:scale-105 disabled:opacity-50 disabled:hover:scale-100"
          >
            {isAccepting ? (
              <Loader2 className="h-8 w-8 text-cg-sage-dark animate-spin" />
            ) : (
              <div className="w-14 h-14 rounded-full bg-cg-sage flex items-center justify-center shadow-md">
                <CallIcon className="h-6 w-6 text-white" />
              </div>
            )}
            <span className="font-semibold text-cg-sage-dark">Accept</span>
          </button>
        </div>
