...
const securityHeaders = [
  {
    ...
    value: [
      ...
      "connect-src 'self' http://localhost:8000 ws://localhost:8000 wss://*.daily.co https://*.daily.co https://commonground-api-gdxg.onrender.com https://*.onrender.com https://unpkg.com https://cdnjs.cloudflare.com https://*.stripe.com",  // Backend API + Daily.co + CDNs + Stripe
