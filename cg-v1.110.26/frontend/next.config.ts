...
const securityHeaders = [
  {
    ...
    value: [
      ...
      "connect-src 'self' http://localhost:8000 ws://localhost:8000 wss://*.daily.co https://*.daily.co https://commonground-api-a0fr.onrender.com https://*.onrender.com wss://*.onrender.com https://unpkg.com https://cdnjs.cloudflare.com https://*.stripe.com https://*.supabase.co wss://*.supabase.co https://*.mapbox.com https://api.mapbox.com https://events.mapbox.com https://*.ingest.us.sentry.io https://*.google-analytics.com https://*.analytics.google.com https://www.googletagmanager.com",  // Backend API + Daily.co + CDNs + Stripe + Supabase + WebSocket + Mapbox + Sentry + GA
