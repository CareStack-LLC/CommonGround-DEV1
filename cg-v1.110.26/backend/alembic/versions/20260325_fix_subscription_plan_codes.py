...
def upgrade() -> None:
    ...
    op.execute("""
        INSERT INTO subscription_plans (
            ...
            0.00, 0.00,
            'prod_U5i6vWb4ktGrTN',
            'price_1T7WgnB3EXvvERPfyu40gtfE',
            NULL,
    ...
    op.execute("""
        INSERT INTO subscription_plans (
            ...
            17.99, 199.99,
            'prod_U5i6Efw49ipfb3',
            'price_1T7WgnB3EXvvERPfcpZeMSSH',
            'price_1T7WgnB3EXvvERPfe7NNFlru',
    ...
    op.execute("""
        INSERT INTO subscription_plans (
            ...
            34.99, 349.99,
            'prod_U5i6lsgC2mOHxn',
            'price_1T7WgoB3EXvvERPfDm7qKpBN',
            'price_1T7WgoB3EXvvERPfmDy9KtDh',
