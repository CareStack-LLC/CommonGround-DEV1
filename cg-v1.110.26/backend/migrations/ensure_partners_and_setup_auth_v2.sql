-- ============================================================================
-- Unified Partner & Auth Setup Script (Run in Supabase SQL Editor) - v2
-- Fixes:
-- 1. Explicitly sets 'codes_used' = 0 (Fixes NOT NULL violation)
-- 2. Explicitly sets 'primary_contact_email' and 'code_prefix'
...
BEGIN
  ...
  INSERT INTO partners (
    ...
    -- ADDED: Explicit fields to prevent NULL errors
    ...
    -- If exists, ensure email is up to date
