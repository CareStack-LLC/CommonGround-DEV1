-- ============================================================================
-- Supabase User Setup for Partner Admins (Run in SQL Editor) - v3
-- Creates auth users with password 'Demo2026!' and links them to partners
-- Fixes:
-- 1. Explicit casting for UUID/Text mismatches
-- 2. Removes 'role' from public.users table (doesn't exist there)
-- ============================================================================
...
BEGIN
  ...
  INSERT INTO public.partner_staff (
    ...
    jenesse_partner_id::uuid, -- Try explicit cast to UUID if column allows
