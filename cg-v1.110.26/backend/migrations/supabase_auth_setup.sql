...
DO $$
DECLARE
  jenesse_partner_id UUID := '9982b74c-49e2-4cf5-9cc0-654872157d1b';
  interval_partner_id UUID := 'd6615875-9494-46e5-b793-55b57d39e2cc';
  
  -- Pre-generated UUIDs for the users to ensure consistency across tables
...
BEGIN
  ...
  -- Deleting from auth.users usually cascades to public.users via triggers, 
  ...
  DELETE FROM public.partner_staff WHERE partner_id IN (jenesse_partner_id, interval_partner_id);
  ...
  INSERT INTO public.users (
    ...
    jenesse_user_id, -- Matches auth.users.id
  ...
  INSERT INTO public.users (
    ...
    interval_user_id, -- Matches auth.users.id
