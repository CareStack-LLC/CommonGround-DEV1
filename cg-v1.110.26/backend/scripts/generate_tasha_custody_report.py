...
async def main():
    print("=" * 60)
    print("GENERATING TASHA'S CUSTODY TIME REPORT")
    ...
    async with AsyncSessionLocal() as db:
        ...
        try:
            ...
            filename = f"tasha_custody_time_report_{date.today()}.pdf"
